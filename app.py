...
# 环境变量
UUID = os.environ.get('UUID', '1d09c597-2f0f-4731-97d3-4b14e2916ef4')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'testbelmo-2e72.onbelmo.uk')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'belmo')         # 节点订阅token
